...
<head>
    ...
    <title>Admin Login | Harrow Mobiles</title>
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ route('admin.login') }}"><b>Mobile</b>Repair</a>
    </div>
...
<script src="{{ asset('admin-panel/dist/js/adminlte.min2167.js?v=3.2.0') }}"></script>
</body>
</html>
