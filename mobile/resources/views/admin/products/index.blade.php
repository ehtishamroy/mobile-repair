            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="products-table" class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    <th width="50">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($product->compare_at_price)
                                                <span
                                                    class="text-muted text-decoration-line-through">{{ $settings->currency_symbol ?? '$' }}{{ number_format($product->compare_at_price, 2) }}</span>
                                            @else
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#products-table').DataTable({
                    ...
                    "responsive": true,
                    "columnDefs": [
                        { "orderable": false, "targets": [0, 2, 11] } // Disable sorting on Checkbox, Image, and Actions columns
                    ],
