        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="brands-table" class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Logo</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.brands.edit', $brand->id) }}" class="btn btn-sm btn-info" title="Edit">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#brands-table').DataTable({
                ...
                "responsive": true,
                "columnDefs": [
                    { "orderable": false, "targets": [1, 6] } // Disable sorting on Logo and Actions columns
                ],
