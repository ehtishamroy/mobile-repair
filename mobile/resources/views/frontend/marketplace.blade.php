  ...
  <div class="marketplace-header py-3">
    <div class="container flex-center flex-wrap gap-3">
      <div class="dropdown show-on-hover">
        <button class="btn dropdown-toggle category-btn" type="button" id="categoryDropdown" data-bs-toggle="dropdown"
        ...
        <ul class="dropdown-menu" aria-labelledby="categoryDropdown">
          <li>
            <a class="dropdown-item {{ !request('category') ? 'active' : '' }}"
              href="{{ route('frontend.marketplace') }}">
          ...
          @foreach($categories as $category)
            <li>
              <a class="dropdown-item {{ request('category') == $category->id ? 'active' : '' }}"
                href="{{ route('frontend.marketplace', ['category' => $category->id]) }}">
                {{ $category->name }}
              </a>
            </li>
          @endforeach
        ...
        <a href="{{ route('frontend.contact') }}" class="top-link d-flex align-items-center gap-2">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              stroke="#5F6C72" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M11.25 11.25H12V16.5H12.75" stroke="#5F6C72" stroke-width="1.5" stroke-linecap="round"
              stroke-linejoin="round" />
            <path
  ...
  <section class="marketplace-main-layout">
    <div class="container py-3">
      ...
      <div class="d-flex flex-wrap align-items-center justify-content-between mb-3">
        <div>
          <button class="btn btn-light d-lg-none" data-bs-toggle="offcanvas" data-bs-target="#offcanvasFilters">
            <i class="bi bi-sliders"></i> Filters
          </button>
        </div>
        <div class="sort-section flex-center gap-3 d-sm-none">
          <div class="dropdown">
            <button class="btn dropdown-toggle sortby-btn" type="button" id="sortDropdownMobile" data-bs-toggle="dropdown"
              aria-expanded="false">
              @php
                $sortOptions = [
            ...
            <ul class="dropdown-menu" aria-labelledby="sortDropdownMobile">
              ...
              @endphp
              <li>
                <a class="dropdown-item {{ $sortBy == 'popular' ? 'active' : '' }}"
                  href="{{ route('frontend.marketplace', array_merge($currentParams, ['sort' => 'popular'])) }}">
                  Most Popular
                </a>
              </li>
              <li>
                <a class="dropdown-item {{ $sortBy == 'price_low' ? 'active' : '' }}"
                  href="{{ route('frontend.marketplace', array_merge($currentParams, ['sort' => 'price_low'])) }}">
                  Price: Low to High
                </a>
              </li>
              <li>
                <a class="dropdown-item {{ $sortBy == 'price_high' ? 'active' : '' }}"
                  href="{{ route('frontend.marketplace', array_merge($currentParams, ['sort' => 'price_high'])) }}">
                  Price: High to Low
                </a>
              </li>
              <li>
                <a class="dropdown-item {{ $sortBy == 'newest' ? 'active' : '' }}"
                  href="{{ route('frontend.marketplace', array_merge($currentParams, ['sort' => 'newest'])) }}">
                  Newest First
                </a>
              </li>
              <li>
                <a class="dropdown-item {{ $sortBy == 'oldest' ? 'active' : '' }}"
                  href="{{ route('frontend.marketplace', array_merge($currentParams, ['sort' => 'oldest'])) }}">
                  Oldest First
                </a>
              </li>
              <li>
                <a class="dropdown-item {{ $sortBy == 'name_asc' ? 'active' : '' }}"
                  href="{{ route('frontend.marketplace', array_merge($currentParams, ['sort' => 'name_asc'])) }}">
                  Name: A to Z
                </a>
              </li>
              <li>
                <a class="dropdown-item {{ $sortBy == 'name_desc' ? 'active' : '' }}"
                  href="{{ route('frontend.marketplace', array_merge($currentParams, ['sort' => 'name_desc'])) }}">
                  Name: Z to A
                </a>
              </li>
            </ul>
      ...
      <div class="row g-3">
        ...
        <aside class="col-lg-3 d-none d-lg-block">
          ...
          <form class="filter-options mt-3" id="categoryFilter">
            ...
            @foreach($categories as $category)
              <div class="form-check">
                <input class="form-check-input" type="radio" name="category" id="cat_{{ $category->id }}"
          ...
          <div class="double_range_slider">
            ...
            <input type="range" class="min_range" min="0" max="10000" value="{{ request('min_price') ?? 0 }}" step="1" />
            <input type="range" class="max_range" min="0" max="10000" value="{{ request('max_price') ?? 10000 }}"
              step="1" />
          </div>

          <div class="flex-center gap-3">
            <input type="text" id="minInput" placeholder="Min price" class="custom-range-input"
              value="{{ request('min_price') ?? '' }}" />
            <input type="text" id="maxInput" placeholder="Max price" class="custom-range-input"
          ...
          <form class="filter-options mt-3" id="priceRadioFilter">
            ...
            @endphp
            <div class="form-check">
              <input class="form-check-input price-radio" type="radio" name="price" id="price1" value="all" data-min=""
                data-max="" {{ !$hasPriceFilter ? 'checked' : '' }} />
              <label class="form-check-label" for="price1"> All Price </label>
            </div>

            <div class="form-check">
              <input class="form-check-input price-radio" type="radio" name="price" id="price2" value="under_20"
                data-min="0" data-max="20" {{ $currentMin == 0 && $currentMax == 20 ? 'checked' : '' }} />
              <label class="form-check-label" for="price2"> Under {{ $settings->currency_symbol ?? '$' }}20 </label>
            </div>

            <div class="form-check">
              <input class="form-check-input price-radio" type="radio" name="price" id="price3" value="25_100"
                data-min="25" data-max="100" {{ $currentMin == 25 && $currentMax == 100 ? 'checked' : '' }} />
            ...
            <div class="form-check">
              <input class="form-check-input price-radio" type="radio" name="price" id="price4" value="100_300"
                data-min="100" data-max="300" {{ $currentMin == 100 && $currentMax == 300 ? 'checked' : '' }} />
            ...
            <div class="form-check">
              <input class="form-check-input price-radio" type="radio" name="price" id="price5" value="300_500"
                data-min="300" data-max="500" {{ $currentMin == 300 && $currentMax == 500 ? 'checked' : '' }} />
            ...
            <div class="form-check">
              <input class="form-check-input price-radio" type="radio" name="price" id="price6" value="500_1000"
                data-min="500" data-max="1000" {{ $currentMin == 500 && $currentMax == 1000 ? 'checked' : '' }} />
            ...
            <div class="form-check">
              <input class="form-check-input price-radio" type="radio" name="price" id="price7" value="1000_10000"
                data-min="1000" data-max="10000" {{ $currentMin == 1000 && $currentMax == 10000 ? 'checked' : '' }} />
              ...
              @foreach($brandChunks as $chunk)
                <div class="col-6">
                  @foreach($chunk as $brand)
                    <div class="form-check">
                      <input class="form-check-input brand-checkbox" type="checkbox" id="brand_{{ $brand->id }}"
          ...
          <div class="popular-tags mt-4">
            ...
            <div class="d-flex flex-wrap gap-2">
              ...
              @foreach($tags as $tag)
                <a href="{{ route('frontend.marketplace', ['tag' => $tag->id]) }}"
                  class="tag-btn {{ request('tag') == $tag->id ? 'active' : '' }}">{{ $tag->name }}</a>
              @endforeach
            </div>
          </div>
              ...
              @foreach($featuredProducts as $index => $product)
                <div class="featured-product-item {{ $index === 0 ? 'active' : '' }}" data-index="{{ $index }}">
                  ...
                  <p class="price-text mb-4">
                    Only for: <span
                      class="price-tag">{{ $settings->currency_symbol ?? '$' }}{{ number_format($product->price, 2) }}</span>
                    @if($product->compare_at_price)
                      <small
                        class="text-muted text-decoration-line-through d-block">{{ $settings->currency_symbol ?? '$' }}{{ number_format($product->compare_at_price, 2) }}</small>
                    @endif
                  </p>
                  ...
                  <div class="d-grid gap-2">
                    <button class="add-cart-btn" onclick="addToCart({{ $product->id }})">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.125 10H16.875" stroke="#5B265D" stroke-width="1.8" stroke-linecap="round"
                          stroke-linejoin="round" />
                        <path d="M11.25 4.375L16.875 10L11.25 15.625" stroke="#5B265D" stroke-width="1.8"
                    ...
                    <a href="{{ route('frontend.product-detail', $product->slug) }}"
                      class="view-details-btn text-decoration-none">
          ...
          <div class="h-100">
            <header class="flex-between">
              ...
              <div class="sort-section flex-center gap-3 d-none d-sm-flex">
                ...
                <div class="dropdown">
                  <button class="btn dropdown-toggle sortby-btn" type="button" id="sortDropdownDesktop"
              ...
              <div class="d-flex align-items-center justify-content-between py-2">
                <div class="d-flex align-items-center flex-wrap gap-2" id="activeFiltersContainer">
                  @if(count($activeFilters) > 0)
                    <span class="text-secondary me-1 fs-14 fw-400">Active Filters:</span>
                ...
                <div class="text-heading fs-14 fw-400">
                  <span class="fw-600 text-dark" id="totalResults">{{ number_format($totalResults) }}</span> Results
                  found.
                </div>
              </div>
            </section>
            ...
            <div class="row row-cols-xxl-5 row-cols-xl-4 row-cols-lg-3 row-cols-sm-2 row-cols-1 g-3" id="productGrid">
                    ...
                    <div class="card-body">
                      <div class="ratio ratio-1x1 thumb">
                        ...
                        <div class="product-actions" style="z-index: 3; position: absolute;">
                          ...
                          @endphp
                          <div class="action-btn wishlist-btn {{ $isInWishlist ? 'active' : '' }}"
                          ...
                          <a href="{{ route('frontend.product-detail', $product->slug) }}" class="action-btn"
                            title="View Product">
                            <i class="bi bi-eye"></i>
                          </a>
                        </div>
                      ...
                      <div class="product-price text-promo">
                        ...
                        @if($product->compare_at_price)
                          <small
                            class="text-muted text-decoration-line-through">{{ $settings->currency_symbol ?? '$' }}{{ number_format($product->compare_at_price, 2) }}</small>
                        @endif
                      </div>
                    </div>
                  </div>
            ...
            <div id="paginationContainer">
              @if($products->hasPages())
                <nav class="pagination-nav d-flex justify-content-center mt-5" aria-label="Page navigation">
                  {{ $products->links() }}
                </nav>
              @endif
            </div>
        ...
        <aside class="">
          ...
          <form class="filter-options mt-3">
            <div class="form-check">
              ...
              <label class="form-check-label" for="cat1">Computer &amp; Laptop</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="category" id="cat2" />
              <label class="form-check-label" for="cat2">Computer Accessories</label>
            </div>
            <div class="form-check">
            ...
            <div class="form-check">
              ...
              <label class="form-check-label" for="cat5">Mobile Accessories</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="category" id="cat6" />
              <label class="form-check-label" for="cat6">Gaming Console</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="category" id="cat7" />
              <label class="form-check-label" for="cat7">Camera &amp; Photo</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="category" id="cat8" />
              <label class="form-check-label" for="cat8">TV &amp; Homes Appliances</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="category" id="cat9" />
              <label class="form-check-label" for="cat9">Watches &amp; Accessories</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="category" id="cat10" />
              <label class="form-check-label" for="cat10">GPS &amp; Navigation</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="category" id="cat11" />
              <label class="form-check-label" for="cat11">Wearable Technology</label>
            </div>
          </form>
          <hr />
          <h3 class="sidebar-heading">Price Range</h3>
          ...
          <div class="brand-filter">
            ...
            <div class="row g-2 mt-3">
              <div class="col-6">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="apple" checked />
                  <label class="form-check-label" for="apple">Apple</label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="microsoft" checked />
                ...
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="symphony" />
                  <label class="form-check-label" for="symphony">Symphony</label>
                </div>
                <div class="form-check">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="lg" checked />
                  <label class="form-check-label" for="lg">LG</label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="oneplus" />
                  <label class="form-check-label" for="oneplus">One Plus</label>
                </div>
              </div>
              ...
              <div class="col-6">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="hp" checked />
                ...
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="panasonic" checked />
          ...
          <div class="side-product-card text-center p-4 mt-3">
            <img src="{{ asset('front-assets/img/watch-collection.svg') }}" alt="Apple Watch" class="img-fluid mb-3" />

            <img src="{{ asset('front-assets/img/apple-watch-7.svg') }}" alt="Apple Logo" class="apple-logo" />
            ...
            <div class="d-grid gap-2">
              <button class="add-cart-btn">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M3.125 10H16.875" stroke="#5B265D" stroke-width="1.8" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M11.25 4.375L16.875 10L11.25 15.625" stroke="#5B265D" stroke-width="1.8" stroke-linecap="round"
                    stroke-linejoin="round" />
                </svg>
                ADD TO CART
              </button>
