                        ...
                        <div class="row" id="normal-delivery-options">
                            <div class="col-md-6 mb-3">
                                <div class="py-4 flex-center flex-column gap-2 border delivery-option-item"
                                    data-delivery="visit"
                                    style="cursor: pointer; border-radius: 8px; min-height: 200px; transition: all 0.3s;">
                                    <i class="fas fa-store" style="font-size: 3rem; color: #684471;"></i>
                                    <label class="form-label fw-600 w-100 text-center" style="font-size: 1.2rem;">Visit
                                        Us</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="py-4 flex-center flex-column gap-2 border delivery-option-item"
                                    ...
                                    <label class="form-label fw-600 w-100 text-center" style="font-size: 1.2rem;">Online
                                        Delivery</label>
