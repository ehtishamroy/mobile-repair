...
@section('content')
  ...
  <div class="marketplace-header py-3">
    <div class="container flex-center flex-wrap gap-3">
      <div class="dropdown">
        <button class="btn dropdown-toggle category-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
          All Category
        </button>
          ...
          <form id="checkoutForm" action="{{ route('frontend.checkout.process') }}" method="POST">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="custom-input" placeholder="First name" name="first_name" id="first_name"
                  required>
              </div>
              <div class="col-md-6 mb-3">
              ...
              <div class="col-12 mb-3">
                ...
                <input type="text" class="custom-input" placeholder="House number and street name" name="address_line_1"
                  id="address_line_1" required>
              </div>
              <div class="col-12 mb-3">
                <label for="address_line_2" class="form-label">Address Line 2 <span
                    class="text-muted">(Optional)</span></label>
                <input type="text" class="custom-input" placeholder="Apartment, suite, unit, etc." name="address_line_2"
                  id="address_line_2">
              </div>
              <div class="col-md-6 mb-3">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="custom-input" placeholder="SW1A 1AA" name="postcode" id="postcode" required
              ...
              <div class="col-12 mb-3">
                <div class="flex-center gap-2">
                  <div class="custom-check">
                    <input type="checkbox" class="form-check-input" name="ship_to_different_address"
              ...
              <div id="shippingAddressSection" class="col-12" style="display: none;">
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="custom-input" placeholder="First name" name="shipping_first_name"
                      id="shipping_first_name">
                  </div>
                  <div class="col-md-6 mb-3">
                    <label for="shipping_last_name" class="form-label">Last Name <span
                        class="text-danger">*</span></label>
                    <input type="text" class="custom-input" placeholder="Last name" name="shipping_last_name"
                      id="shipping_last_name">
                  </div>
                  <div class="col-12 mb-3">
                    <label for="shipping_address_line_1" class="form-label">Address Line 1 <span
                        class="text-danger">*</span></label>
                    <input type="text" class="custom-input" placeholder="House number and street name"
                      name="shipping_address_line_1" id="shipping_address_line_1">
                  </div>
                  <div class="col-12 mb-3">
                    <label for="shipping_address_line_2" class="form-label">Address Line 2 <span
                        class="text-muted">(Optional)</span></label>
                    <input type="text" class="custom-input" placeholder="Apartment, suite, unit, etc."
                      name="shipping_address_line_2" id="shipping_address_line_2">
                  </div>
                  <div class="col-md-6 mb-3">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="custom-input" placeholder="County" name="shipping_county"
                      id="shipping_county">
                  </div>
                  <div class="col-md-6 mb-3">
                    <label for="shipping_postcode" class="form-label">Postcode <span class="text-danger">*</span></label>
                    <input type="text" class="custom-input" placeholder="SW1A 1AA" name="shipping_postcode"
            ...
            <div class="payment-option mb-4">
              <h3 class="fw-500 fs-18 p-3">Payment Details</h3>
              <hr class="mt-0" />
              ...
              <div id="stripePaymentSection" class="p-3">
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input type="text" id="cardholder-name" class="custom-input" placeholder="John Doe" required>
                  </div>
                  <div class="col-12 mb-3">
                  ...
                  <div class="col-md-4 col-12 mb-3">
                    ...
                    <input type="text" id="card-zip" class="custom-input" placeholder="12345" maxlength="10" required>
                  </div>
                  <div class="col-12">
            ...
            <div class="additional-information">
              ...
              <div class="p-3">
                ...
                <textarea name="order_notes" rows="5" class="w-100 custom-input"
          ...
          <div class="card-total">
              ...
              @foreach($cartItems as $item)
                <div class="d-flex align-items-center mb-4">
                  <img
                    ...
                    alt="{{ $item['name'] }}" width="70" class="me-3 rounded" />
                  <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <span
                        class="text-promo fw-500 fs-14">{{ $currencySymbol }}{{ number_format($item['price'], 2) }}</span>
                    </div>
                  </div>
                </div>
              @endforeach
            ...
            <div class="coupon-box mb-3">
              ...
              <div class="coupon-form">
                <input type="text" class="custom-input mb-3" id="checkoutCouponCode" placeholder="Enter coupon code"
                  value="{{ $appliedCoupon ?? '' }}" {{ $appliedCoupon ? 'disabled' : '' }} />
                @if(!$appliedCoupon)
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <span class="fw-600 text-heading fs-16">{{ $currencySymbol }}{{ number_format($total, 2) }}
                {{ $settings->currency ?? 'GBP' }}</span>
            </div>
  ...
  @push('scripts')
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function () {
        ...
        const cardNumberElement = elements.create('cardNumber', { style: elementStyles });
        const cardExpiryElement = elements.create('cardExpiry', { style: elementStyles });
        const cardCvcElement = elements.create('cardCvc', { style: elementStyles });
