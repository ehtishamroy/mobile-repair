    ...
    <div class="container">
      ...
      <div class="row row-cols-lg-2 row-cols-1 g-3 mt-5">
        ...
        @foreach($customerItems as $index => $item)
          <div class="col">
            <div class="flex-stack flex-column h-100 p-4 rounded-3" style="background-color: #F6F6F6;">
              ...
              <img src="{{ asset('front-assets/img/' . ($customerImages[$index] ?? 'customer-satisfaction-1.svg')) }}"
